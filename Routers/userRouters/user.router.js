...
export let forgotPass = async(req, res)=>{
    ...
    try {
        ...
        let mailOption = {
            ...
            <a href=http://localhost:3000/reset-password/${isExist._id}/${token} style="display: inline-block; background-color: red; color: white; padding: 10px 20px; text-align: center; text-decoration: none; border-radius: 5px; cursor: pointer;">Click here </a>
